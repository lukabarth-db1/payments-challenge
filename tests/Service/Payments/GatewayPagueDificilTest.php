...
class GatewayPagueDificilTest extends TestCase
{
    /**
     * @before
     */
    ...
    public function testExecute_PaymentInArgentinaShouldHavePagueDificilAsProvider(): void
    {
        ...
        $this->assertEquals('PagueDificil', $providerRepository->FindById($paymentId));
    ...
    public function testExecute_PaymentInArgentinaIfProviderIsNotPagueDificil(): void
    {
        // arrange
        $paymentInfo = new CreatePaymentInfo(
            amount: 1589.45,
        ...
        $pagueDificil = $gatewayFactory->gatewayHandler('ar');
        ...
        $this->expectExceptionMessage('PagueDificil only accepts payments from Argentina');
